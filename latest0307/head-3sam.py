...
# optimizers = ['AdamW', 'Adagrad', 'Adamax','Adam'] # Optimizerを追加
# learning_rates = [1e-3, 1e-4, 1e-5, 1.6e-3]
...
batch_sizes = [16]
#batch_sizes = [8, 16, 32]
model_names = ['vit_base_patch16_224.augreg_in21k', 'vit_small_patch16_224.augreg_in21k']
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' : #and epoch_acc > best_acc:  変更点
                if epoch_loss < best_loss: # lossが減少したとき
                    ...
                    # 各foldの最良モデルを保存
                    model_save_path = f"./model/CCSN_3class-sam-vit/gridsearch/best_{model_name}_batch{batch_size}_{optimizer_name}_lr{lr}_fold{fold}.pth"
...
for batch_size in batch_sizes:
    for model_name in model_names:
        for optimizer_name in optimizers:
            ...
            # 結果を保存するディレクトリを作成
                result_dir = f"./image/aug-sam-vit-gridsearch/{model_name}_batch{batch_size}_{optimizer_name}_{lr}"
